...
namespace C42_G01_LINQ0.classes
{
    ...
    internal static class ListGenerator
    {
        ...
        static ListGenerator()
        {
            ...
            // provide data from XML file
            //CustomerList = from e in XDocument.Load("D:\\Asp.Net Course\\C# Programing\\C42-G01-LINQ0\\Demo\\bin\\Debug\\net8.0\\Customers.Xml").Root.Elements("customer") select new Customer() { CustomerID =(string) e.Element("id"),--- };
